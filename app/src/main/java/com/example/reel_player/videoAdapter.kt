...
import com.example.reel_player.databinding.VideoListsBinding
...
class videoAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VideoViewHolder {
        val view = VideoListsBinding.inflate(LayoutInflater.from(context), parent, false)
